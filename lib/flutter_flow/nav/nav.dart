...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const PeopleWidget() : const LoginPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/addNewAdmin',
          asyncParams: {
            'user': getDoc(['admin'], AdminRecord.fromSnapshot),
          },
        ...
        FFRoute(
          ...
          builder: (context, params) => AddOperatorWidget(
            user: params.getParam('user', ParamType.Document),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => ChangePasswordWidget(
            ...
            activate: params.getParam('activate', ParamType.String),
        ...
        FFRoute(
          name: 'LinkSentPage',
          path: '/linkSentPage',
          builder: (context, params) => const LinkSentPageWidget(),
        )
